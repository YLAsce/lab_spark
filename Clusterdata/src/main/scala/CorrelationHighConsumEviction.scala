...
object CorrelationHighConsumEviction {
    def main(args: Array[String]): Unit = {
        ...
        var files_task_events = Files.walk(Paths.get("./src/main/data/task_events"), FileVisitOption.FOLLOW_LINKS).toArray
        var files_task_usage = Files.walk(Paths.get("./src/main/data/task_usage"), FileVisitOption.FOLLOW_LINKS).toArray
